...
const translations = {
    zh: {
        'toolbar.up': '返回上级目录',
        'toolbar.scan': '刷新目录',
        'toolbar.scanning': '刷新中…',
        'toolbar.chooseDir': '选择目录',
        'toolbar.analyzeAll': 'AI分析目录',
        ...
        'settings.concNote': '批量「AI分析目录」时同时进行的数量。越大越快，但更易触发厂家限流；设为 1 即逐个分析。',
    ...
    en: {
        ...
        'toolbar.scan': 'Refresh Folder',
        'toolbar.scanning': 'Refreshing…',
        'toolbar.chooseDir': 'Choose Folder',
        'toolbar.analyzeAll': 'Analyze with AI',
